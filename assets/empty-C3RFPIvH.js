...
import{C as e,D as t,Dt as n,O as r,ct as i,k as a,q as o,w as s}from"./vue-router-DpP-iWv7.js";import{O as c,Q as l,T as u,at as d,ot as f,tt as p}from"./index-CqA6ZM_a.js";import{t as m}from"./AppPageLayout-b-gp_UZ6.js";var h={},g={class:`flex gap-2`};function _(n,a){let c=l,f=d,p=u;return o(),s(p,{icon:`i-lucide:folder-open`,title:`没有项目`,description:`您尚未创建任何项目，请从创建第一个项目开始`},{default:i(()=>[e(`div`,g,[r(c,null,{default:i(()=>[...a[0]||(a[0]=[t(` 创建项目 `,-1)])]),_:1}),r(c,{variant:`outline`},{default:i(()=>[...a[1]||(a[1]=[t(` 导入项目 `,-1)])]),_:1})]),r(c,{variant:`link`,class:`text-muted-foreground`,size:`sm`},{default:i(()=>[a[2]||(a[2]=t(` 了解更多 `,-1)),r(f,{name:`i-lucide:arrow-up-right`})]),_:1})]),_:1})}var v=f(h,[[`render`,_]]),y=`<template>
