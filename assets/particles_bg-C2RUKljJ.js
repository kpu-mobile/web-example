...
import{C as e,Dt as t,E as n,O as r,ct as i,k as a,q as o,w as s}from"./vue-router-DpP-iWv7.js";import{O as c,b as l,ht as u,ot as d}from"./index-CqA6ZM_a.js";import{t as f}from"./AppPageLayout-b-gp_UZ6.js";var p={class:`p-2 bg-background flex flex-col h-50 w-full items-center justify-center relative overflow-hidden`},m=a({__name:`_demo1`,setup(e){let i=u();return(e,a)=>{let s=l;return o(),n(`div`,p,[r(s,{class:`inset-0 absolute`,color:t(i).currentColorScheme===`dark`?`#FFF`:`#000`},null,8,[`color`])])}}}),h=`<script setup lang="ts">
