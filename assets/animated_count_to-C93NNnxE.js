...
import{Dt as e,E as t,O as n,ct as r,k as i,kt as a,q as o,w as s,yt as c}from"./vue-router-DpP-iWv7.js";import{M as l,O as u,j as d}from"./index-D4TT8-Ku.js";import{t as f}from"./AppPageLayout-DuOJLTKk.js";var p=i({__name:`_demo1`,setup(t){let n=c(0);return setInterval(()=>{n.value+=Math.floor(Math.random()*1e3)*(Math.random()>.5?1:-1)},2e3),(t,r)=>{let i=d;return o(),s(i,{value:e(n),"will-change":``,class:`text-4xl font-bold`},null,8,[`value`])}}}),m=`<script setup lang="ts">
const value = ref(0)
