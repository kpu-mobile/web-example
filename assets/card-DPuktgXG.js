...
import{D as e,Dt as t,E as n,O as r,Y as i,_ as a,ct as o,k as s,q as c,w as l}from"./vue-router-DpP-iWv7.js";import{O as u,Z as d,ot as f}from"./index-CqA6ZM_a.js";import{t as p}from"./AppPageLayout-b-gp_UZ6.js";var m={},h={class:`flex flex-col gap-4`};function g(t,s){let l=d;return c(),n(`div`,h,[(c(),n(a,null,i(3,t=>r(l,{key:t,title:`卡片标题`,description:`卡片描述`,class:`w-full`},{footer:o(()=>[...s[0]||(s[0]=[e(` 卡片底部 `,-1)])]),default:o(()=>[s[1]||(s[1]=e(` 卡片内容 `,-1))]),_:1})),64))])}var _=f(m,[[`render`,g]]),v=`<template>
