...
import{C as e,Dt as t,Nt as n,O as r,ct as i,k as a,kt as o,q as s,w as c}from"./vue-router-DpP-iWv7.js";import{O as l,P as u,h as d,ot as f}from"./index-CqA6ZM_a.js";import{t as p}from"./AppPageLayout-b-gp_UZ6.js";var m={};function h(e,t){let n=d;return s(),c(n,{items:[`Kpu-mobile v6 正式发布，欢迎体验新特性！`,`框架已支持 Vue 3.6 + Vite 8，性能大幅提升`,`新增 30+ 内建 UI 组件，开箱即用`,`支持亮色/暗色主题，一键切换`],class:`text-sm flex-1 h-6`})}var g=f(m,[[`render`,h]]),_=`<template>
  <KmScrollingText
    :items="[
