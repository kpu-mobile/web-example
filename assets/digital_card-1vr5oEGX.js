...
import{Dt as e,E as t,O as n,ct as r,k as i,q as a,w as o}from"./vue-router-DpP-iWv7.js";import{E as s,O as c,ot as l}from"./index-D4TT8-Ku.js";import{t as u}from"./AppPageLayout-DuOJLTKk.js";var d={},f={class:`flex flex-col gap-4`};function p(e,r){let i=s;return a(),t(`div`,f,[n(i,{title:`总收入`,icon:`i-carbon:currency-yen`,digital:`￥45,231.89`,description:`较上周上升19%`,trend:`up`}),n(i,{title:`订阅数`,icon:`i-mynaui:users`,digital:`+50`,description:`较上周下降3%`,trend:`down`}),n(i,{title:`销售额`,icon:`i-bytesize:creditcard`,digital:`+12,234`,description:`较上周上升55%`,trend:`stable`}),n(i,{title:`活跃用户`,"title-tips":`仅统计近一小时的活跃用户数量`,icon:`i-carbon:activity`,digital:`+573`,description:`较近一小时上升10%`})])}var m=l(d,[[`render`,p]]),h=`<template>
